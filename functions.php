...
if( ! function_exists('twentyseventeen_content_width') ):
/** 设置内容宽度
...
if( ! function_exists('twentyseventeen_resource_hints') ):
/** 对资源（字体样式文件url）预取，提高性能
...
if( ! function_exists('twentyseventeen_widgets_init') ):
...
if( ! function_exists('twentyseventeen_javascript_detection') ):
...
if( ! function_exists('twentyseventeen_pingback_header') ):
...
if( ! function_exists('twentyseventeen_colors_css_wrap') ):
/** 添加自定义color css代码到<head>
...
function twentyseventeen_colors_css_wrap() {
	...
	require_once( get_parent_theme_file_path( '/inc/color-patterns.php' ) );//包含并运行一次
...
if( ! function_exists('twentyseventeen_content_image_sizes_attr') ):
...
if( ! function_exists('twentyseventeen_header_image_tag') ):
/**
...
if( ! function_exists('twentyseventeen_post_thumbnail_sizes_attr') ):
/** 为文章缩略图中的图片添加自定义sizes属性，增强响应式图片功能
 * Add custom image sizes attribute to enhance responsive image functionality
 * for post thumbnails.
 *
 * @since Twenty Seventeen 1.0
...
if( ! function_exists('twentyseventeen_front_page_template') ):
/**
...
if( ! function_exists('twentyseventeen_widget_tag_cloud_args') ):
